        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">Tambah Kurir</h4>
                        <div class="general-label">
                            <form class="form-horizontal" role="form" action="{{route('courier.store')}}" method="POST">
                                @csrf
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="courier" name="courier" class="form-control" placeholder="Nama Kurir" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
