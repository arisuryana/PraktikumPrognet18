        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">Update Kategori</h4>
                        <div class="general-label">
                            <form class="form-horizontal" role="form" action="{{route('categories.update',$categories->id)}}" method="POST">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="category_name" name="category_name" class="form-control" placeholder="Nama Kategori" value="{{$categories->category_name}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
